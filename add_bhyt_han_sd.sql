...
-- Thêm 2 cột hạn sử dụng BHYT vào bảng bhyt_than_nhan
ALTER TABLE public.bhyt_than_nhan
ADD COLUMN IF NOT EXISTS ngay_han_sd_bhyt_tu date,
ADD COLUMN IF NOT EXISTS ngay_han_sd_bhyt_den date;
...
VALUES 
    ...
    ('bhyt_than_nhan', 'ngay_han_sd_bhyt_tu', true),
    ('bhyt_than_nhan', 'ngay_han_sd_bhyt_den', true)
